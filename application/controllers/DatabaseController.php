...
class DatabaseController extends Zend_Controller_Action
{
	...
	public function init()
	{
		...
		$list[] = array('categories_attributes', array('4', '2'));
		$list[] = array('categories_attributes', array('4', '3'));
		$list[] = array('categories_attributes', array('4', '4'));
		$list[] = array('categories_attributes', array('4', '5'));
		$list[] = array('categories_attributes', array('4', '6'));
		$list[] = array('categories_attributes', array('4', '7'));
		$list[] = array('categories_attributes', array('4', '8'));
		$list[] = array('categories_attributes', array('4', '9'));
		$list[] = array('categories_attributes', array('4', '10'));
		$list[] = array('categories_attributes', array('4', '11'));
		$list[] = array('categories_attributes', array('4', '12'));
		 
		$list[] = array('categories_attributes', array('5', '2'));
		$list[] = array('categories_attributes', array('5', '3'));
		$list[] = array('categories_attributes', array('5', '4'));
		$list[] = array('categories_attributes', array('5', '5'));
		$list[] = array('categories_attributes', array('5', '6'));
		$list[] = array('categories_attributes', array('5', '7'));
		$list[] = array('categories_attributes', array('5', '8'));
		$list[] = array('categories_attributes', array('5', '9'));
		$list[] = array('categories_attributes', array('5', '10'));
		$list[] = array('categories_attributes', array('5', '11'));
		$list[] = array('categories_attributes', array('5', '12'));
		 
		$list[] = array('categories_attributes', array('6', '2'));
		$list[] = array('categories_attributes', array('6', '3'));
		$list[] = array('categories_attributes', array('6', '4'));
		$list[] = array('categories_attributes', array('6', '5'));
		$list[] = array('categories_attributes', array('6', '6'));
		$list[] = array('categories_attributes', array('6', '7'));
		$list[] = array('categories_attributes', array('6', '8'));
		$list[] = array('categories_attributes', array('6', '9'));
		$list[] = array('categories_attributes', array('6', '10'));
		$list[] = array('categories_attributes', array('6', '11'));
		$list[] = array('categories_attributes', array('6', '12'));
		 
		//cat_att motoryzacja 7-9
		$list[] = array('categories_attributes', array('7', '13'));
		$list[] = array('categories_attributes', array('7', '14'));
		$list[] = array('categories_attributes', array('7', '15'));
		$list[] = array('categories_attributes', array('7', '16'));
		$list[] = array('categories_attributes', array('7', '17'));
		$list[] = array('categories_attributes', array('7', '18'));
		$list[] = array('categories_attributes', array('7', '19'));
		$list[] = array('categories_attributes', array('7', '20'));
		$list[] = array('categories_attributes', array('7', '21'));
		$list[] = array('categories_attributes', array('7', '22'));
		$list[] = array('categories_attributes', array('7', '23'));
		$list[] = array('categories_attributes', array('7', '24'));
		 
		$list[] = array('categories_attributes', array('8', '13'));
		$list[] = array('categories_attributes', array('8', '14'));
		$list[] = array('categories_attributes', array('8', '15'));
		$list[] = array('categories_attributes', array('8', '16'));
		$list[] = array('categories_attributes', array('8', '17'));
		$list[] = array('categories_attributes', array('8', '18'));
		$list[] = array('categories_attributes', array('8', '19'));
		$list[] = array('categories_attributes', array('8', '20'));
		$list[] = array('categories_attributes', array('8', '21'));
		$list[] = array('categories_attributes', array('8', '22'));
		$list[] = array('categories_attributes', array('8', '23'));
		$list[] = array('categories_attributes', array('8', '24'));
		 
		$list[] = array('categories_attributes', array('9', '13'));
		$list[] = array('categories_attributes', array('9', '14'));
		$list[] = array('categories_attributes', array('9', '15'));
		$list[] = array('categories_attributes', array('9', '16'));
		$list[] = array('categories_attributes', array('9', '17'));
		$list[] = array('categories_attributes', array('9', '18'));
		$list[] = array('categories_attributes', array('9', '19'));
		$list[] = array('categories_attributes', array('9', '20'));
		$list[] = array('categories_attributes', array('9', '21'));
		$list[] = array('categories_attributes', array('9', '22'));
		$list[] = array('categories_attributes', array('9', '23'));
		$list[] = array('categories_attributes', array('9', '24'));
		 
		//cat_att praca 10-11
		$list[] = array('categories_attributes', array('10', '25'));
		$list[] = array('categories_attributes', array('10', '26'));
		$list[] = array('categories_attributes', array('10', '27'));
		$list[] = array('categories_attributes', array('10', '28'));
		 
		$list[] = array('categories_attributes', array('11', '25'));
		$list[] = array('categories_attributes', array('11', '26'));
		$list[] = array('categories_attributes', array('11', '27'));
		$list[] = array('categories_attributes', array('11', '28'));
